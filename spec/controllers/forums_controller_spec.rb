...
#       forum = Forum.create! valid_attributes
#       get :show, params: {id: forum.to_param}, session: valid_session
...
#     it "assigns the requested forum as @forum" do
#       forum = Forum.create! valid_attributes
#       get :edit, params: {id: forum.to_param}, session: valid_session
#       expect(assigns(:forum)).to eq(forum)
#     end
#   end
...
#         expect {
#           post :create, params: {forum: valid_attributes}, session: valid_session
...
#         post :create, params: {forum: invalid_attributes}, session: valid_session
#         expect(assigns(:forum)).to be_a_new(Forum)
#       end
...
#         forum = Forum.create! valid_attributes
#         put :update, params: {id: forum.to_param, forum: new_attributes}, session: valid_session
#         forum.reload
...
#       it "assigns the requested forum as @forum" do
#         forum = Forum.create! valid_attributes
#         put :update, params: {id: forum.to_param, forum: valid_attributes}, session: valid_session
#         expect(assigns(:forum)).to eq(forum)
#       end
...
#         forum = Forum.create! valid_attributes
#         put :update, params: {id: forum.to_param, forum: invalid_attributes}, session: valid_session
#         expect(assigns(:forum)).to eq(forum)
#       end
...
#       forum = Forum.create! valid_attributes
#       expect {
#         delete :destroy, params: {id: forum.to_param}, session: valid_session
#       }.to change(Forum, :count).by(-1)
#     end
